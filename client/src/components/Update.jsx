...
const Update = (props) => {
    ...
    return (
        <div className='container'>
            ...
            { loaded && (
            <>
                <Forms onSubmitProp={updateProduct} initialTitle={product.title} initialPrice={product.price} initialDescription={product.description} />
                <DeleteButton itemId={product._id} successCallback={()=> navigate('/home')}/>
            </>
            )}
        </div>
    )
